                        ...
                        <Col xs={9}>
                            <Row >
                                <Col className="plan-1" xs={4}>
                                    <a onClick={e=>this.clickHandler(e, '/invest-cal/api/plans/gold-plan/payment')} href="/payement" ><img alt="plan" src={plan_1} /></a>
                                </Col>
                                <Col xs={4}>
                                    <a onClick={e=>this.clickHandler(e, '/invest-cal/api/plans/diamond-plan/payment')}  href="/payement"><img alt="plan" src={plan_2} /></a>
                                </Col>
                                <Col className="mt-5" xs={4}>
                                    <a onClick={e=>this.clickHandler(e, '/invest-cal/api/plans/silver-plan/payment')} href="/payement"> <img alt="plan" src={plan_3} /></a>
                                </Col>
                            </Row>
                        </Col>
                        <Col xs={1}>
